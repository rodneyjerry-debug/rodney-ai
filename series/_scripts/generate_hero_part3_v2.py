"""
Generate hero banner for Part 3 using the boardroom/ecosystem image.
...
# Target dimensions — match Part 1/2 hero aspect ratio
W, H = 1400, 933
...
# Scale to fill W×H without cropping — letterbox if needed, but this image
# is landscape so we scale to fill width and pad height if needed
...
# Create the base image from the darkened photo
img = photo.copy()
...
# Series tag
draw.text((90, 50), "SERIES 03  //  PART 3 OF 5  //  CAPITAL EFFICIENCY", fill=GOLD, font=font_series)

# Main stat
draw.text((90, 150), "SAR 2.5B", fill=WHITE, font=font_stat_large)

# Subtitle
draw.text((90, 270), "Released capital per year, Base case.", fill=GOLD, font=font_subtitle)
draw.text((90, 310), "Every basis point of RWA density", fill=WHITE, font=font_sub2)
draw.text((90, 338), "is a board decision now.", fill=WHITE, font=font_sub2)
...
stats = [
    ("CAR TODAY", "19.2%", "sector-wide, Sept 2024"),
    ("OUTPUT FLOOR", "72.5%", "Basel IV, phased to 2028"),
...
# Save
out_path = "/sessions/cool-elegant-cori/charts/hero_part3.png"
img.save(out_path, "PNG", quality=95)
print(f"Saved: {out_path} ({os.path.getsize(out_path)} bytes)")

brand_path = "/sessions/cool-elegant-cori/mnt/CV/Rodney's AI Desk/brand/09_hero_part3.png"
img.save(brand_path, "PNG", quality=95)
