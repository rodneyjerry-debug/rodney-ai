"""
Generate hero banner for Misconceptions Series Part 3 — Investment Management.
...
font_money = ImageFont.truetype("/usr/share/fonts/truetype/dejavu/DejaVuSans-Bold.ttf", 28)
...
# Series tag
draw.text((90, 50), "AI IN FS: MISCONCEPTIONS & FIRST PRINCIPLES  //  PART 3 OF 4  //  INVESTMENT MANAGEMENT", fill=GOLD, font=font_series)

# Main headline — the misconception (struck through visually)
y_main = 120

# "AI governance is a" line
draw.text((90, y_main), '"AI governance is a', fill=(180, 180, 180), font=font_main)
bbox1 = draw.textbbox((90, y_main), '"AI governance is a', font=font_main)
mid_y1 = (bbox1[1] + bbox1[3]) // 2
draw.line([(bbox1[0], mid_y1), (bbox1[2], mid_y1)], fill=RED_ACCENT, width=4)

# "compliance exercise."
draw.text((90, y_main + 60), 'compliance exercise."', fill=(180, 180, 180), font=font_main)
bbox2 = draw.textbbox((90, y_main + 60), 'compliance exercise."', font=font_main)
...
draw.text((90, y_main + 155), "Governance is", fill=WHITE, font=font_main_lg)
draw.text((90, y_main + 220), "architecture.", fill=GOLD, font=font_main_lg)

# Subtitle
draw.text((90, y_main + 310), "If your governance lives in a document,", fill=LIGHT_BLUE, font=font_subtitle)
draw.text((90, y_main + 342), "it governs nothing.", fill=WHITE, font=font_subtitle)

# Money line
draw.text((90, y_main + 400), "Show me the code.", fill=GOLD, font=font_money)

# Name and title
draw.text((90, y_main + 450), "RODNEY COUTINHO", fill=WHITE, font=font_name)
draw.text((90, y_main + 478), "Executive Advisor on AI  //  Enterprise.AI", fill=LIGHT_BLUE, font=font_title)
...
stats = [
    ("GUARDRAIL LAYERS", "3", "safety, quality, compliance"),
    ("GOVERNANCE TYPE", "Runtime", "code, not paperwork"),
    ("WORKING EXAMPLE", "Portfolio", "CIO risk report agent"),
]
...
byline = "ENTERPRISE.AI  //  AI STRATEGY, GOVERNANCE & DEPLOYMENT  //  INVESTMENT MANAGEMENT  //  MIDDLE EAST & EUROPE"
draw.text((90, H - 38), byline, fill=DIM_BLUE, font=font_byline)

# Save
out_dir = "/sessions/cool-elegant-cori/mnt/Claude/rodney-ai/series-misconceptions/part-3-investment-management/charts"
os.makedirs(out_dir, exist_ok=True)
out_path = os.path.join(out_dir, "hero_part3.png")
